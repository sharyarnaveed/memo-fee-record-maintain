...
<body>
  <main class="signup_main">
    <section class="image_sign">
      <img src="resources/images/nathan-dumlao-5tNBKg_cXkw-unsplash.jpg" alt="" />
    </section>
...
';
      ...
      <div class="the_form">
        <form class="sign_up" action="" method="post" enctype="multipart/form-data">
          <input class="sign_up_input" type="text" name="fname" pattern="[A-Za-z]+" title="Only Aplhabets are allowed" placeholder="First Name" />
          <input class="sign_up_input" type="text" name="lname" placeholder="Last Name" pattern="[A-Za-z]+" title="Only Aplhabets are allowed" />
          <input class="sign_up_input" type="text" name="email" placeholder="Email" />
          <input class="sign_up_input" type="text" name="username" placeholder="User Name" />
          <?php
          if ($showerror) {
          ...
          <input class="sign_up_input" type="password" name="password" placeholder="Password" minlength="8" maxlength="15" />

          <input class="sign_up_input" type="password" name="rpassword" minlength="8" maxlength="15" placeholder="Repeat Password" />
          ...
          <div class="sign_up_button">
            <input type="submit" class="sign_up_submit_button" value="Sign Up" name="submit" />
          </div>
        </form>
      </div>
    </section>
